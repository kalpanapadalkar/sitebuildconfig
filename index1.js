...
const repoPath = '/Users/kalpana.padalkar/Documents/sitebuildconfig2/sitebuildconfig';
// const repoPath = 'https://github.com/kalpanapadalkar/sitebuildconfig';

exec(`cd ${repoPath} && git reset --hard && git clean -f && git checkout master && git pull`);
// exec(`cd ${repoPath} && git reset --hard && git clean -f && git checkout master && git pull`);
// // Repo name
